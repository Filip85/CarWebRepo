...
namespace ProjectServi.DataAccess
{
    public interface IVehicleServiceRepository
    {
        ...
        Task<List<VehicleModelD>> GetAllAsyncM(CancellationToken cancellationToken = default(CancellationToken));
        Task CreateAsyncM(VehicleModelD vehicle, CancellationToken cancellationToken = default(CancellationToken));
    }
}
